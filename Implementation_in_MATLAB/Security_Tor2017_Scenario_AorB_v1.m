...
opts.VariableNames = ["SourceIP", "SourcePort", "DestinationIP", "DestinationPort", "Protocol", "FlowDuration", "FlowBytess", "FlowPacketss", "FlowIATMean", "FlowIATStd", "FlowIATMax", "FlowIATMin", "FwdIATMean", "FwdIATStd", "FwdIATMax", "FwdIATMin", "BwdIATMean", "BwdIATStd", "BwdIATMax", "BwdIATMin", "ActiveMean", "ActiveStd", "ActiveMax", "ActiveMin", "IdleMean", "IdleStd", "IdleMax", "IdleMin", "label"];
opts.VariableTypes = ["categorical", "double", "categorical", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "categorical"];
...
opts = setvaropts(opts, ["SourceIP", "DestinationIP", "label"], "EmptyFieldRule", "auto");
opts = setvaropts(opts, ["SourcePort", "DestinationPort", "Protocol", "FlowDuration", "FlowBytess", "FlowPacketss", "FlowIATMean", "FlowIATStd", "FlowIATMax", "FlowIATMin", "FwdIATMean", "FwdIATStd", "FwdIATMax", "FwdIATMin", "BwdIATMean", "BwdIATStd", "BwdIATMax", "BwdIATMin", "ActiveMean", "ActiveStd", "ActiveMax", "ActiveMin", "IdleMean", "IdleStd", "IdleMax", "IdleMin"], "FillValue", 0);

% Import the data
ScenarioNum = 2;        % 1: Scenario A and 2: Scenario B
Selected_Data = readtable(FileNames{ScenarioNum}, opts);

clear opts
%% D-reduction using PCA
[coeff, score] = pca(Selected_Data{:,4:end-1});
...
%%
BoxPlot_Acc_Dist(SResults, 100 + ScenarioNum, ClassNum)
